...
macro(toy_BuildModule _name)
	...
	set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${TOY_ROOT_BINARY_DIR}/lib/toy)
	...
	if(MSVC)
		set_target_properties(${_name} PROPERTIES
			...
			ARCHIVE_OUTPUT_DIRECTORY            ${TOY_ROOT_BINARY_DIR}/lib/toy
			ARCHIVE_OUTPUT_DIRECTORY_DEBUG      ${TOY_ROOT_BINARY_DIR}/lib/toy
			ARCHIVE_OUTPUT_DIRECTORY_RELEASE    ${TOY_ROOT_BINARY_DIR}/lib/toy
		)
	else()
		if(WIN32)
