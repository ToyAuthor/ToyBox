...
--	local  stream = file.create_stream("zip")       -- Create a file stream with zlib.
--	local  stream = file.create_stream("7zip")      -- Create a file stream with 7zip.
	local  stream = file.create_stream("default")   -- Create a file stream with folder.

	local  buffer = file.create_image_buffer()      -- Create a empty buffer for loading image data.
